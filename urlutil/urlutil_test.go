...
func TestRemoveDefaultPortStr(t *testing.T) {
	tests := []struct {
		input    string
		expected string
		hasError bool
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			result, err := RemoveDefaultPortStr(tt.input)
...
func TestRemoveDefaultPortURL(t *testing.T) {
	tests := []struct {
		input    string
		expected string
	}{
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			...
			if u.String() != tt.expected {
				t.Errorf("RemoveDefaultPort(%q): expected %q, got %q", tt.input, tt.expected, u.String())
			}
		})
	}
}
